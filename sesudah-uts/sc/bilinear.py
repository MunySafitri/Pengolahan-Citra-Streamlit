...
def main():
    st.title("Image Bilinear Interpolation App")
    ...
    if uploaded_image is not None:
        ...
        if st.button("Interpolate Image"):
            ...
            st.image(interpolated_image, caption=f"Bilinear Interpolated Image (Scale Factor: {scale_factor})", use_column_width=True)
